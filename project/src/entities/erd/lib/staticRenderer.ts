import type { ErdDocumentV1, ErdRelation } from "../model/erd";
import { relationLabel } from "../model/erd";
import { buildTableBoxes, HEADER_HEIGHT, ROW_HEIGHT, relationVisualStyle, routeRelation, type RelationSide, type TableBox } from "./relations";
