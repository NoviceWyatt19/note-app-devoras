import type { ErdDocumentV1, ErdEndpointCardinality, ErdRelation, ErdTable } from "../model/erd";
...
export function routeRelation(_document: ErdDocumentV1, relation: ErdRelation, boxes: TableBox[]): RoutedRelation | null {
